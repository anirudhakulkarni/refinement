...
def set_loader(opt):
    ...
    train_loader = DataLoader(train_set, batch_size=opt.batch_size, num_workers=opt.num_workers, sampler=train_sampler)
    # val_loader = DataLoader(val_set, batch_size=opt.batch_size, num_workers=opt.num_workers, drop_last=False, sampler=val_sampler)

    test_set = TinyImageNet(    split='val',
                               transform=transform_test,
                               in_memory=True)
    print(test_set)
    test_loader = DataLoader(test_set, batch_size=opt.batch_size, shuffle=False, num_workers=opt.num_workers, drop_last=False)
