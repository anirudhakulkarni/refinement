...
class SOTAs(torch.optim.Optimizer):
    ...
    def __init__(self, model, loss, gammas=(0.9, 0.9), lr=1e-3, 
                 betas=(0.9, 0.999), eps=1e-8, mode = 'Adam',
        ...
        self.steps = 0
        self.loss = loss
        self.loss.set_betas(beta_0=gammas[0], beta_1=gammas[1])
    ...
    def update_lr(self, decay_factor=None):
        if decay_factor != None:
            ...
            self.loss.update_betas(decay_factor)
