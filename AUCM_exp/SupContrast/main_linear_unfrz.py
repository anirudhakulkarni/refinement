...
def parse_option():
    ...
    opt.model_name = 'SupLinearUFZ_{}_{}_im_{}_lr_{}_decay_{}_bsz_{}'.\
...
def main():
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        # train for one epoch
        time1 = time.time()
        loss, train_auc,eces,sces = train(train_loader, model, classifier, criterion, optimizer, epoch, opt)
        ...
        # eval for one epoch
        loss, val_auc, eces, sces = validate(val_loader, model, classifier, criterion, opt)
