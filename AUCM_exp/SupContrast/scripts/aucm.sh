...
screen bash -c \
"python3 train.py --cls_type binary --loss aucm--dataset cifar10 --model densenet121 --imratio 0.01 --batch_size 129"

export CUDA_VISIBLE_DEVICES='1'
screen bash -c \
"python3 train.py --cls_type binary --loss aucm --dataset cifar10 --model resnet20 --imratio 0.01 --batch_size 129"

export CUDA_VISIBLE_DEVICES='2'
screen bash -c \
"python3 train.py --cls_type binary --loss aucm --dataset cifar100 --model densenet121 --imratio 0.01 --batch_size 129"

export CUDA_VISIBLE_DEVICES='3'
screen bash -c \
"python3 train.py --cls_type binary --loss aucm --dataset cifar100 --model resnet20 --imratio 0.01 --batch_size 129"
