...
screen -dm bash -c  \
"python main_supcon.py --batch_size 1024   --learning_rate 0.5   --temp 0.1 --dataset cifar10 --imratio 0.1 --model resnet50 --cosine && \
python main_supcon.py --batch_size 1024   --learning_rate 0.5   --temp 0.1 --dataset cifar100 --imratio 0.1 --model resnet50 --cosine && \
python main_supcon.py --batch_size 1024   --learning_rate 0.5   --temp 0.1 --dataset stl10 --imratio 0.1 --model resnet50 --cosine && \
python main_supcon.py --batch_size 1024   --learning_rate 0.5   --temp 0.1 --dataset c2 --imratio 0.1 --model resnet50 --cosine"
