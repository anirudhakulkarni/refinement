...
optimizer, milestones=[50,75,95,98], gamma=0.1)
for epoch in range(100):
    ...
    # epoch_gamma = epoch_update_gamma(last_whole_y_t, last_whole_y_pred, epoch,delta)
    epoch_gamma = 0.7
    model.train()
    scheduler.step()
...
# save results
with open(lossfunction + "_results_cifar10_"+str(SEED)+".txt", "a+") as f:
    f.write("train_auc: " +
