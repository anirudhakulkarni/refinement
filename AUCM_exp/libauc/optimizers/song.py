...
class SONG(torch.optim.Optimizer):
    """
    This is a wrapper of SONG_ADAM and SONG_SGD:
        - the optimization mode can be 'sgd' (with momentum) or 'adam'
        - you can specify \eta in our paper by setting lr
        - you can specify \beta_1 in our paper by setting momentum=1-\beta_1 (in 'sgd' mode)
                                      or by setting betas[0]=1-\beta_1 (in 'adam' mode)
    """
    def __init__(self, params, lr=required, weight_decay=0, mode='sgd',
                 momentum=0.9, dampening=0, nesterov=False, # sgd
        ...
        super(SONG, self).__init__(params, defaults)
