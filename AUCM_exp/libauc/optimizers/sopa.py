...
class SOPA(torch.optim.Optimizer):
    ...
    def __init__(self, model,  loss, mode = 'Adam', 
                 eta=1.0, lr=1e-3, weight_decay=0, 
                 betas=(0.9, 0.999), eps=1e-8, amsgrad=False,
                 momentum=0.9, nesterov=False, dampening=0):
    ...
    def update_lr(self, decay_factor=None):
        if decay_factor != None:
            ...
            self.loss.update_eta(decay_factor) # for moving average
